...
class PhysicsTextSystem {
    constructor() {
        ...
        // 技能文字列表
        this.skills = [
            { text: 'Vue.js', color: '#00d4ff', size: 26 },
            { text: 'CSS', color: '#00d4ff', size: 26 },
            { text: 'Javascript', color: '#ffffff', size: 26 },
            { text: 'Typescript', color: '#ffffff', size: 26 },
            { text: 'Python', color: '#00d4ff', size: 28 },
            { text: 'HTML', color: '#00d4ff', size: 26 },
            { text: 'C++', color: '#ffffff', size: 26 },
            { text: 'C#', color: '#00d4ff', size: 26 },
            { text: 'Java', color: '#00d4ff', size: 32 },
            { text: 'Kubernetes', color: '#ffffff', size: 24 },
            { text: 'Go', color: '#00d4ff', size: 24 },
            { text: 'Photoshop', color: '#ffffff', size: 22 },
            { text: 'Mybatis-Plus', color: '#ffffff', size: 24 },
            { text: 'Git', color: '#00d4ff', size: 28 },
            { text: 'TailwindCSS', color: '#00d4ff', size: 26 },
            { text: 'Vite', color: '#ffffff', size: 24 },
            { text: 'React', color: '#00d4ff', size: 26 },
            ...
            { text: 'JUnit', color: '#00d4ff', size: 26 },
            { text: 'Node.js', color: '#00d4ff', size: 28 },
            { text: 'Npm', color: '#00d4ff', size: 26 },
            { text: 'Elasticsearch', color: '#00d4ff', size: 28 },
            { text: 'MySQL', color: '#ffffff', size: 26 },
            { text: 'JMeter', color: '#ffffff', size: 30 },
            ...
            { text: 'Postman', color: '#ffffff', size: 30 }
        ];
...
const projectShowcase = {
    ...
    projectsData: [
        ...
        {
            title: '大型线上交易中台系统',
            desc: '微服务大型线上交易中台系统，前后端分离设计，整合 Spring AI 完成智能化改造',
            tags: ['高并发', 'Spring AI', 'Java'],
